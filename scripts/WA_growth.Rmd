...
p = ggplot(ltt.dat) + geom_ribbon(aes(x=time, ymin=val_offset-val/2, ymax=val_offset+val/2, group=cluster, fill=clade)) +
  ...
  geom_text(aes(x=as.Date("2020-02-4"), label="0", y=250), colour="black", text=element_text(size=6))+
  geom_text(aes(x=as.Date("2020-02-4"), label="50", y=300), colour="black", text=element_text(size=6))+
  geom_text(aes(x=as.Date("2020-02-4"), label="100", y=350), colour="black", text=element_text(size=6))+
