...
for (rep in seq(0,8)){
  ...
  p=ggplot() +
    ...
    scale_y_log10()+
    # geom_histogram(data=new_inf, aes(x=t, weight=val), binwidth=1/366, fill="green",alpha=0.5) +
...
p_R0 = ggplot(growth) + 
  ...
  geom_ribbon(aes(x=time, ymin=R.ll, ymax=R.uu, fill="coalesent skyline"), alpha=0.2) +
